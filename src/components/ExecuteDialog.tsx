...
// Pre-flight confirmation for a command that opens Terminal.app. Items
// marked "silent" never reach this dialog — they run straight away (see
// lib/silentRun.ts); their warning lives in the editor instead.
